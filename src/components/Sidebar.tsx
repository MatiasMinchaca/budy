import { SparklesIcon, ChevronLeftIcon } from '@heroicons/react/24/solid'
...
export default function Sidebar({ onClose, darkMode }: SidebarProps) {
    return (
        <div className={`bg-gray-800 ${darkMode ? 'dark:bg-gray-900' : ''} text-white w-64 flex flex-col h-full`}>
            <div className="p-4 text-xl font-bold">Historial</div>
            <div className="flex-grow">
                {/* Aquí iría la lista del historial */}
            </div>
